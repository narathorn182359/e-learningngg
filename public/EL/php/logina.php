        ...
        $.ajax({
                    ...
                    success: function (data) {
						...
						if(data.indexOf("success")>0){
							console.log("WT ",data)
							window.location.href = "./produc.php";
						}
						else{
							alert("ข้อมูลไม่ถูกต้องกรุณาติดต่อผู้ดูแลระบบ")
							//window.location.href = "./produc.php";
						}
...
<div class="login-form">
    <form action="/examples/actions/confirmation.php" method="post">
        ...
        <div class="form-group">
            <button type="button" onclick="checklog()" class="btn btn-primary btn-lg btn-block">Sign in</button>
        </div>
