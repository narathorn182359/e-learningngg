                        ...
                        <div class="content">
                            <form>
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มหมวดหมู่</button>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle">
                            ...
                            <span class="icon-bar bar1">
                                <button type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal" data-target="#myModal">เพิ่มหมวดหมู่</button>
                            </span>
                            <span class="icon-bar bar2"></span>
                            <span class="icon-bar bar3"></span>
                        </button>
                        <a class="navbar-brand" href="#">จัดการหมวดหมู่</a>
                    </div>
