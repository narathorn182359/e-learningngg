...
<body>
    <div class="wrapper">
        ...
        <div class="modal fade" id="myModallob" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">กรุณาใส่พิน-ทำการลบ</h4>
                    </div>
                    <div class="modal-body">
                    <input type="password" id="pin"  placeholder="Abc1234!$"/>
                    </div>
                    <div class="modal-footer">
                        <button onclick="lobjing()" type="button" class="btn btn-default" data-dismiss="modal">ตกลง</button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="myModallobfail" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">กรุณาใส่พินเพ่ือทำการลบ</h4>
                    </div>
                    <div class="modal-body">
    คุณใส่พินไม่ถูกต้อง ระบบจะทำการบันทึกข้อมูล IP และ MAC Address ของคุณเพื่อตรวจสอบการเข้าถึง
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal fade" id="myModal3" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">แก้ไขข้อมูลจัดการผู้ดูแลระบบ</h4>
                        </div>
                        <div class="modal-body">
                            <div class="content">
                            <form>
...
<div class="text-center">
    ...
    <button type="button" onclick="pass()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">แก้ไขข้อมูลผู้ดูแลระบบ</button>
</div>
<div class="clearfix"></div>
</form>
                            </div>
                            ...
                            <div class="content">
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="idemp_" type="text" class="form-control border-input" placeholder="somchai">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>รหัสผ่าน</label>
                                                <input id="citiemp_" type="password" class="form-control border-input" placeholder="1212312121">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>ชื่อ นามสกุล</label>
                                                <input id="titleemp_" type="text" class="form-control border-input" placeholder="นาย">
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มผู้ดูแลระบบ.</button>
                                    </div>
                                    <div class="clearfix"></div>
                                </form>
                            </div>
                            ...
                            <button type="button" class="navbar-toggle">
                                ...
                                <span class="icon-bar bar1">
                                    <button onclick="fetchtype()" type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal"
                                        data-target="#myModal">เพิ่มผู้ดูแลระบบ</button>
                                </span>
                                <span class="icon-bar bar2"></span>
                                <span class="icon-bar bar3"></span>
                            </button>
                            <a class="navbar-brand" href="#">จัดการผู้ดูแลระบบ</a>
                        </div>
...
// $start_work =  $row["start_work"];   
                    ...
                    content += '<tr>'
                    content += '   <th>ลำดับ</th>'
                    content += '   <th>ชื่อ นามสกุล</th>'
                    content += '   <th>รหัสผู้ใช้งาน</th>'
                    ...
                    for (var i = 0; i < allData.length - 1; i++) {
                      //  console.log("----", allData[i])
                        ...
                        content += '  <td>' + j + '</td>'
                        content += '  <td><span id="emptitle_' + _f[0] + '">' + _f[2] + '</span></td>'
                        content += '  <td><span id="empid_' + _f[0] + '">' + _f[1] + '</span></td>'
                        
                        content += '  <td> <button type="button"  onclick="lob(' + _f[0] + ')"  style="background-color:teal;" class="btn btn-fill ">ยุติบทบาท</button></td>'
                        content += '</tr>'
                    ...
                    $('#example').DataTable({
                        ...
                        "oLanguage": {
                            ...
                            "sSearch": "ค้นหาจัดการผู้ดูแลระบบ"
 ...
 $.ajax({
            ...
            var doooo = $('#doornotdo').val();
                ...
                $.ajax({
                    ...
                    data: { "id":IDE,"emp_id": idemp_old, "emp_idcard": citiemp_old, "name_title": titleemp_old, "name": nameemp_old, 
                        "department": depemp_old,"company": compemp_old,"last_name" : suremp_old,"start_work" : startemp_old },
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> แก้ไขข้อมูลผู้ดูแลระบบสำเร็จ </span>"
                            )
    ...
    function save() {
      ...
      // console.log("slectpr  ", $('#sel1').val())
        ...
        var emp_id = $('#idemp_').val()
        var emp_idcard = $('#citiemp_').val()
        var name_title = $('#titleemp_').val()
       

        console.log("--> ",emp_id , emp_idcard , name_title)
        ...
        if (emp_id.length < 1 || emp_idcard.length < 1 || name_title.length <1) {
            console.log("กรอกไม่ครบ")
            $('#eee').css("display", "");
        }
        else {
            $('#eee').css("display", "none");
                ...
                $.ajax({
                    url: "ajaxpro3emadd.php",
                    type: "POST",
                    data: { "emp_id": emp_id, "emp_idcard": emp_idcard, "name_title": name_title},
                    success: function (data) {
                        // html = '<img src="' + resp + '" />';
                        // $("#upload-demo-i").html(html);
                        console.log(data)
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> เพิ่มข้อมูลจัดการผู้ดูแลระบบสำเร็จ </span>"
                            )
