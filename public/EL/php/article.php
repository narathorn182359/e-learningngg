        ...
        <div class="modal fade" id="myModal3" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">แก้ไขข้อมูลบทความ</h4>
                    </div>
                    <div class="modal-body">
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>ประเภท</label>
                                            <div class="form-group">
                                            <select class="form-control" id="select_new_">
                                            <option>คลังความรู้</option>
                                            <option>ความเชื่อ/การดูแลรักษา</option>
                                            <option>เกร็ดความรู้</option>
                                            <option>กิจกรรม</option>
                                            </select>      </div>  
                                            <!-- <input id="select_new" type="text" class="form-control border-input" placeholder="ประเภท"> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="pass()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">แก้ไขบทความ</button>
                                </div>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">เพิ่มบทความ</h4>
                    </div>
                    <div class="modal-body">
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="cat_new" type="text" class="form-control border-input" placeholder="ชื่อบทความ">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>ประเภท</label>
                                            <div class="form-group">
                                            <select class="form-control" id="select_new">
                                            <option>คลังความรู้</option>
                                            <option>ความเชื่อ/การดูแลรักษา</option>
                                            <option>เกร็ดความรู้</option>
                                            <option>กิจกรรม</option>
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มบทความ</button>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle">
                            ...
                            <span class="icon-bar bar1">
                                <button type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal" data-target="#myModal">เพิ่มบทความ</button>
                            </span>
                            <span class="icon-bar bar2"></span>
                            <span class="icon-bar bar3"></span>
                        </button>
                        <a class="navbar-brand" href="#">จัดการบทความ</a>
                    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.indexOf('0000000000') > 0) {
                    ...
                    content += '<tr>'
                    content += '   <th>ลำดับ</th>'
                    content += '   <th>ชื่อบทความ</th>'
                    content += '   <th>ประเภท</th>'
                    ...
                    for (var i = 0; i < allData.length - 1; i++) {
                        ...
                        content += '  <td><span id="paped_' + _f[0] + '">' + _f[4] + '</span></td>'
                        content += '  <td><span' + _f[0] + '">' + _f[2].substring(0, 20) + '...</span><div style="display:none" id="des_' + _f[0] + '">' + _f[2] + '</div></td>'
        ...
        if (a.length < 1 || b.length < 1) {
            ...
            $uploadCrop_.croppie('result', {
                ...
                $.ajax({
                    url: "ajaxpro2.php",
                    type: "POST",
                    data: { "image": resp, "cat": cat, "des": des,"doooo":doooo,"id":id_e ,"type":ttt},
                    success: function (data) {
                        // html = '<img src="' + resp + '" />';
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> แก้ไขข้อมูลบทความสำเร็จ </span>"
                            )
        ...
        if (a.length < 1) {
            ...
            $uploadCrop.croppie('result', {
                ...
                $.ajax({
                    url: "ajaxpro.php",
                    type: "POST",
                    data: { "image": resp, "cat": cat, "des": des,"type":ttt },
                    success: function (data) {
                        // html = '<img src="' + resp + '" />';
                        // $("#upload-demo-i").html(html);
                        console.log(data)
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> เพิ่มข้อมูลบทความสำเร็จ </span>"
                            )
