                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <label>ตำแหน่ง/แผนก</label>
                                            <input id="pass_older_pa" type="text" class="form-control border-input">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="pass()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">แก้ไขงาน</button>
                                </div>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>ชื่องาน</label>
                                            <input id="cat_new" type="text" class="form-control border-input" placeholder="ชื่องาน">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    <label>ตำแหน่ง/แผนก</label>
                                            <input id="pass_older_pax" type="text" class="form-control border-input">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มงาน</button>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle">
                            ...
                            <span class="icon-bar bar1">
                                <button type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal" data-target="#myModal">เพิ่มงาน</button>
                            </span>
                            <span class="icon-bar bar2"></span>
                            <span class="icon-bar bar3"></span>
                        </button>
                        <a class="navbar-brand" href="#">จัดการงาน</a>
                    </div>
            ...
            success: function (data) {
                ...
                if (data.indexOf('0000000000') > 0) {
                    ...
                    for (var i = 0; i < allData.length - 1; i++) {
                        ...
                        content += '  <td><span id="img_' + _f[0] + '"><img src="upload/' + _f[3] + '" style="width:20%"/></span></td>'
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> แก้ไขข้อมูลงานสำเร็จ </span>"
                            )
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> เพิ่มข้อมูลงานสำเร็จ </span>"
                            )
