                        ...
                        <div class="content">
                            <form>
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="pass()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">แก้ไขสินค้า</button>
                                </div>
                        ...
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="cat_new" type="text" class="form-control border-input" placeholder="ชื่อสินค้า">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มสินค้า</button>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle">
                            ...
                            <span class="icon-bar bar1">
                                <button type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal" data-target="#myModal">เพิ่มสินค้า</button>
                            </span>
...
<script>
                ...
                if (data.indexOf('0000000000') > 0) {
                   ...
                   // content += '   <th>ประเภท</th>'
                    ...
                    for (var i = 0; i < allData.length - 1; i++) {
                       ...
                       //<span' + _f[0] + '">' + _f[2].substring(0, 20) + '...</span>
                        content += '  <td><div style="display:none" id="des_' + _f[0] + '">' + _f[2] + '...</div></td>'
    ...
    function passclick(res) {
        ...
        console.log("passclick <a href='#eee.php'>jjj</a>", des)
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> แก้ไขข้อมูลสินค้าสำเร็จ </span>"
                            )
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> เพิ่มข้อมูลสินค้าสำเร็จ </span>"
                            )
