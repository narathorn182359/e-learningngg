            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li >
                        <a href="sinka.php">
                            <i class="ti-text"></i>
                            <p style="font-size:16px">จัดการแบนเนอร์</p>
                        </a>
                    </li>
                    <li >
                        <a href="producX.php">
                    ...
                    <div class="modal-body">
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                <input id="older" type="text" placeholder="youtube link เพื่อแสดงในหน้าแรก" style="width:90%;margin-left:5%">
                                </div>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">เพิ่มyoutube หน้าแรก</h4>
                    </div>
                    <div class="modal-body">
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style="text-align:center">
                                            <strong>ภาพyoutube หน้าแรก</strong>
                                            <br/>
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="save()" style="background-color:teal;" class="btn btn-info btn-fill btn-wd">เพิ่มyoutube หน้าแรก</button>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle">
                            ...
                            <span class="icon-bar bar1">
                                <!-- <button type="button" style="background-color:royalblue;" class="btn btn-info btn-fill btn-wd" data-toggle="modal" data-target="#myModal">เพิ่มyoutube หน้าแรก</button> -->
                            </span>
                            <span class="icon-bar bar2"></span>
                            <span class="icon-bar bar3"></span>
                        </button>
                        <a class="navbar-brand" href="#">จัดการyoutube หน้าแรก</a>
                    </div>
...
<script>
            ...
            success: function (data) {
                ...
                if (data.indexOf('0000000000') > 0) {
                    ...
                    for (var i = 0; i < allData.length - 1; i++) {
                        ...
                        content += '  <td> <iframe width="100%" style="height:400px" src="'+oldlink+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>'
    ...
    function pass() {
        ...
        if (1<1) {
          ...
          var newlink = $('#older').val()


                $.ajax({
                    url: "ajaxpro5link.php",
                    type: "POST",
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> แก้ไขข้อมูลyoutube หน้าแรกสำเร็จ </span>"
                            )
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf('successfully') > 0) {
                            ...
                            $('#mdr').append(
                                ...
                                "<span style='color:green'> เพิ่มข้อมูลyoutube หน้าแรกสำเร็จ </span>"
                            )
