...
<section class="fillter_latest_product">
    <div class="container">
        <div class="single_c_title">
            <h1 style="font-family : Prompt">คอร์สเรียน</h1>
        </div>
        <div class="fillter_l_p_inner">
            <ul class="fillter_l_p" style="display:flex;justify-content:center;align-items:center;">

                <div id="papeds2"></div>
                <input type="text" class="form-control searchCourse" id="serg" name="serg" placeholder="ค้นหาคอร์สเรียน"
                    style="border-radius:0px;margin-top: 15px ; width: 30% ; margin-left: 10px ;height: 40px;">
                <div
                onclick="searchg()"
                    style="cursor:pointer; font-family : Prompt ; width:80px;height:35px ;background-color: #e02a2a ;margin-top: 15px;display:flex;justify-content:center;align-items:center;border-radius:50px;color:#fff ;margin-left: 15px">
                    ค้นหา
                </div>
            </ul>
    </div>
...
<div class="container">
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <a href="{{url('learningCorse/'.$item->id)}}">
