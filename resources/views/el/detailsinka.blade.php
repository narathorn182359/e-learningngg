        ...
        <div class="solid_banner_innerC">
            <ul>
                ...
                <a href="{{url('/')}}" style="font-family: Prompt">หน้าหลัก</a>
                    ...
                    <li>
                        <a href="{{url('/product')}}" style="font-family: Prompt">คลังความรู้</a>
                    </li>
                    <li>
                        <a href="#" style="font-family: Prompt">{{$newsinka->name_}}</a>
                    </li>
                </ul>
            </div>
    </section>
...
<div class="carousel-inner">
    ...
    <img src="{{url('/upload/'.$newsinka->img_)}}" alt="Los Angeles" style="width:90%;">
    </div>
</div>
...
<br><br>
      <div style="width:100%;">
        <span class="fontContent" style="font-family : Prompt">
            <h4> <?php echo  htmlspecialchars_decode($newsinka->des_)    ?> </h4>
        </span>
        </div>
    </div>
