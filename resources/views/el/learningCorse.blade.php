...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown submenu active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item active"><a class="nav-link" href="{{url('learningOnline')}}"
    ...
    <section class="container">
        ...
        <div class="solid_banner_innerC">
            <ul>
            <li><a href="{{url('/')}}" style="font-family: Prompt">หน้าหลัก</a></li>
                <li><a href="#" style="font-family: Prompt">เรียนออนไลน์</a></li>
                <!-- <li><a href="#" style="font-size:16px;font-weight:bold ;font-family : Prompt">ชื่อคอร์สเรียน</a> -->
                </li>
            </ul>
        </div>
    </section>
    <div class="container">
        ...
        <h1 style="margin-top:50px ;font-family : Prompt">
            {{$product->name_}}
        </h1>
...
<center>
    <img src="{{url('/upload/'.$product->img_)}}" alt="Los Angeles" style="width:90%;">
</center>
...
<br><br>
  <div style="width:100%;">
    <span class="fontContent" style="font-family : Prompt">
        <h4> <?php echo  htmlspecialchars_decode($product->des_)    ?> </h4>
    </span>
    </div>
    <center><a href="javascript:void(0)" class="btn btn-danger  showx ">อ่านก่อนทดสอบ</a></center>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">รายละเอียดการทำแบบทดสอบ</h4>
        </div>
        <div class="modal-body">
         <p>(1) คุณต้องทำแบบทดสอบจำนวน 10 ข้อ</p>
         <p>(2) ข้อสอบทั้งหมดเป็น Multiple Choice 4 ตัวเลือก</p>
         <p>(3) ให้เลือกข้อที่ถูกต้องที่สุด เพียงข้อละ 1 ตัวเลือกเท่านั้น</p>
         <p> (4) ต้องทำได้อย่างน้อย 8 ข้อ ถึงจะผ่านการทดสอบวิชานี้</p>
         <p>(5) หากไม่ผ่านเกณฑ์การสอบจะต้องสอบใหม่จนกว่าจะผ่าน</p>
         <p>(6) ข้อสอบมีระยะเวลากำหนดในการสอบเช่นต้องสอบภายใน 7 วัน</p>
         <center>

            <a href="{{url('showtest/'.$product->id)}}"   class="btn btn-danger"> เริ่มทดสอบ </a>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <script src="{{asset('js/getshowtest.js')}}"></script>
<script>
