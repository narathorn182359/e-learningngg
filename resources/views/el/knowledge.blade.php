...
<body>
    ...
    <!--================Feature Add Area =================-->
        ...
        <div class="container">
            <div class="s_m_title">
                <h2 style="font-family : Prompt">คลังความรู้</h2>
            </div>
                 <div class="row">
                    ...
                    <div class="col-md-3">
                       <div class="card">
                           <div class="card-image">
                               <figure class="image ">
                               <img  id="img_articel{{$item->img_}}"   class="blur"           src="{{url('/upload/'.$item->img_)}}" alt="Placeholder image">
                               </figure>
                             </div>

                             <div class="content">
                                <h4>
                                    <a href="{{url('article_l/'.$item->id)}}" class="text23" style="color: black">
                                {{$item->name_}}
                               </a></h4>
                         </div>
                    </div>
    ...
    <div class="container">
        <div class="s_m_title">
            <h2 style="font-family : Prompt">ความเชื่อ/การดูแลรักษา</h2>
        </div>
             <div class="row">
    ...
    <div class="container">
        <div class="s_m_title">
            <h2 style="font-family : Prompt">เกร็ดความรู้</h2>
        </div>
             <div class="row">
