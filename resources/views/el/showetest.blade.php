...
<body>
    ...
    <div class="header_top_area topW">
        <div class="container">
            <div class="row">
                ...
                <img  id="NGG_Logo" class="blur" src="{{url('img/NGG_Logo_Red.png')}}" alt="" style="width:20%;margin-top: 20px">
                </div>
                <div class="col-lg-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"
                    ...
                    <img src="{{url('img/NGG_Logo_Red.png')}}" alt="" style="width:20%;margin-top: 20px">
                </div>
                <div class="col-lg-3">
                    <div class="top_right_header">
                        <ul class="header_social">
    ...
    <header class="shop_header_area topNav">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            style="font-family : Prompt ;font-size: 18px">หลักสูตรของฉัน
                        </a>
                       </li>
            ...
            <div class="stepwizard" hidden>
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="stepwizard-step col-xs-3" >
                        <a href="#step-{{$j}}" type="button" class="btn btn-success btn-circle">{{$j}}</a>
                        <p><small>#</small></p>
                    </div>
                    @else
                    <div class="stepwizard-step col-xs-3">
                        <a href="#step-{{$j}}" type="button" class="btn btn-default btn-circle" disabled="disabled">{{$j}}</a>
        ...
        <form role="form"  method="POST"  action="{{url('showtestdata')}}">
            @csrf
        <input type="hidden" name="vichar" value="{{Request()->id}}">
                <?php $l = 1; ?>
                @foreach ($test as $tests)
                @if($loop->last)
                <div class="panel panel-primary setup-content" id="step-{{$l}}">
                    <div class="panel-heading">
                         <h3 class="panel-title">{{$l}}.{{$tests->question}}</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                                <label class="control-label" style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]"   value="1"    required >{{$tests->choice1}}</label><br>
                                <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]"  value="2"   required>{{$tests->choice2}}</label><br>
                                <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]"  value="3"    required>{{$tests->choice3}}</label><br>
                                <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]"  value="4"   required>{{$tests->choice4}}</label><br>
                         </div>
                        <button class="btn btn-success pull-right" type="submit">บันทึกคำตอบ</button>
                    </div>
                </div>
                ...
                <div class="panel panel-primary setup-content" id="step-{{$l}}">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]"  value="2" required>{{$tests->choice2}}</label><br>
                            <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]" value="3" required>{{$tests->choice3}}</label><br>
                            <label class="control-label"  style="font-size: 16px;"><input type="radio" name="choice{{$l}}[]" value="4" required>{{$tests->choice4}}</label>
                         </div>
                        <button class="btn btn-danger nextBtn pull-right" type="button">ถัดไป</button>
                    </div>
                </div>
