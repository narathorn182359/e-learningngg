...
<body>
    ...
    <section class="container">
        <div class="solid_banner_innerC">
            <ul>
                <li>
                <a href="{{url('/')}}" style="font-family: Prompt">หน้าหลัก</a>
                </li>
                    <li>
                        <a href="#" style="font-family: Prompt">ติดต่อเรา</a>
                    </li>
                </ul>
            </div>
        <div class="conW" style="width:100% ;justify-content:center;align-items:center;flex-direction:column ">
            <div class="col-lg-8" style="display:flex;justify-content:center;align-items:center;flex-direction:column">
                <div class="top_header_middle">
                    <a href="#" style="font-size:25px ;font-family : Prompt ;color: #999"><i
                            class="fa fa-phone" style="font-size:25px ;color: #444"></i> Call Us: <span
                            style="font-size:20px">065-871-7999</span></a>
                    <a href="#" style="font-size:25px ;font-family : Prompt ;color: #999"><i
                            class="fa fa-envelope" style="font-size:25px ;color: #444"></i> Email:
                        <span style="font-size:20px">hrd3@ciengems.com</span></a>
                </div>
            </div>
            <!-- <div class="loca">
                <img src="img/icon/Lopcation.png" alt="Los Angeles"
                    style="width: 30px;margin-right: 20px;margin-left: 50px">
                <span style="font-size:20px ;font-family : Prompt ">สถานที่ตั้ง</span>
            </div> -->
        </div>
        ...
        <div class="container">
                ...
                <iframe width="100%"
                 src="https://maps.google.com/maps?q=%E0%B8%9A%E0%B8%A3%E0%B8%B4%E0%B8%A9%E0%B8%B1%E0%B8%97%20NGG%20Timepieces&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
