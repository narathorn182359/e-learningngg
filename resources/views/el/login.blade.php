                ...
                <div class="col-lg-3">
                    <div class="top_right_header">
                        ...
                        <ul class="top_right" style="display:flex;justify-content: center ; align-items: center">
                            <li class="user"><a href="{{url('/loginuser')}}"
    ...
    <section class="feature_product_area">
        <div class="container">
            <div class="row" style="display:flex;justify-content:center">
                <div class="col-lg-6"
                    style="flex-direction: column;width:100%;height:650px; background-color:#eee ;display:flex;align-items:center">
                    <h3 style="font-family : Prompt ;margin-left: 15px ;margin-top:30px">
                        กรอกข้อมูลเพื่อเข้าสู่ระบบ</h3>
                    <div style="margin-top:30px">
                        <div class="f_add_item right_dir">
                            <!-- <div class="f_add_img containerX"
                                style="width: 200px;height: 200px ; border:solid ; border-width: 1px; border-color: #000">
                                <div style="width: 100%;height: 100% ; display: flex ; flex-direction: column ">
                                    <img class="img-fluid" src="img/icon/person.png" alt=""
                    ...
                    @if(isset($_GET['identity']) && isset($_GET['password']))
                     <input type="text" id="identity" name="identity" placeholder="ชื่อผู้ใช้" value="{{$_GET['identity']}}"
                        style="margin-top:30px;width:70%;font-size: 22px ; border: solid;background-color:#eee ;border-bottom-color: #999 ;border-top-color: #eee;border-left-color: #eee ;border-right-color: #eee ;border-width: 1px">
                   ...
                   <input type="text" id="identity" name="identity" placeholder="ชื่อผู้ใช้" value=""
                   style="margin-top:30px;width:70%;font-size: 22px ; border: solid;background-color:#eee ;border-bottom-color: #999 ;border-top-color: #eee;border-left-color: #eee ;border-right-color: #eee ;border-width: 1px">
               <input type="password" id="password" name="password" placeholder="รหัสผ่าน"
                   value=""
                   style="margin-top:30px;width:70%;font-size: 22px ; border: solid;background-color:#eee ;border-bottom-color: #999 ;border-top-color: #eee;border-left-color: #eee ;border-right-color: #eee ;border-width: 1px">
                    ...
                    <br/>
                        <div style="display:flex">
                            ...
                            <!-- <input id= "ra1" style="display:inline-block" type="radio" name="gender" value="employee"> พนักงาน<br>
                            <input id= "ra2" style="display:inline-block; margin-left: 10px" type="radio" name="gender" value="other"> บุคคลทั่วไป<br> -->

                    </div>

                    <div style="width:70% ;display:flex;justify-content:center;align-items:center; margin-top:30px">


                            <input type="submit" value="เข้าสู่ระบบ"   style="font-size: 25px;font-family : Prompt ; width:100%;height:45px ;background-color: #e02a2a ;display:flex;justify-content:center;align-items:center;border-radius:50px;color:#fff ;">

                    </div>
                    <!-- <div class="row feature_inner"
                        style="font-size:22px ;width:70% ; display: flex;flex-direction: row ; margin-top:30px">
                        <p style="font-size:22px ;font-family : Prompt ;margin-bottom: 0px ;">
                            ลืมรหัสผ่าน</p>
                    </div> -->
                    <!-- <div class="row feature_inner"
                        style="font-size:22px ;display: flex;flex-direction: row ; margin-top:10px; text-align: center">
                        <a href="register2.php">
                            <p
                                style="font-size:20px ;font-family : Prompt ;margin-bottom: 0px ;color:#e02a2a">
                                ลงทะเบียน (สำหรับผู้ใช้ระบบใหม่)</p>
                        </a>
                    </div> -->
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var name = $("input[name=identity]").val();
...
$.ajax({
   ...
   data:{identity:name, password:password},
