...
<body>
    ...
    <section class="container">
        ...
        <div class="solid_banner_innerC" >


            <div class="row feature_inner headerROW"
                style="width:100% ; display: flex;flex-direction: row ; margin-top:30px">
                <!-- <div class="col-lg-4 proPic" style=" margin-top:30px">
                    <div class="f_add_img containerX"
                        style="width: 250px;height: 250px ; border:solid ; border-width: 1px; border-color: #000">
                        <div style="width: 100%;height: 100% ; display: flex ; flex-direction: column ">
                            <img class="img-fluid" src="img/icon/person.png" alt="" style="width:100%;height:100%">
                        </div>
                    </div>
                    <div class="btnProPic"
                        style="font-family : Prompt ; width:120px;height:35px ;background-color: #fff ;margin-top: 15px;display:flex;justify-content:center;align-items:center;border-radius:50px;color:#000 ;border: solid;border-width: 1px;border-color: #999">
                        แก้ไขรูปโปรไฟล์
                    </div>
                </div> -->
                <div class="col-lg-12" style=" margin-top:30px">
                <div class="row feature_inner nameP" style="width:100% ; display: flex;flex-direction: row ;">
                        <div class="col-lg-8" style=" margin-top:30px">
                        <img style="width:30%" src="{{url('upload/'.$employee->pic)}}"/>
                        </div>
                    ...
                    <div class="row feature_inner nameP" style="width:100% ; display: flex;flex-direction: row ;">
                        <div class="col-lg-8" style=" margin-top:30px">
                            <p class="main_name" style="font-family : Prompt ; margin-bottom:-5px ;font-size: 30px ;color:#000">

                                </p>
                        </div>
                        <!-- // $_SESSION["ses_id"] =$_POST['ses_id'];
                            // $_SESSION["emp_id"] = $_POST['emp_id'];
                            // $_SESSION["emp_idcard"] = $_POST['temp_idcardype_'];
                            // $_SESSION["name_title"] = $_POST['name_title'];
                            // $_SESSION["name"] = $_POST['name'];
                            // $_SESSION["last_name"] = $_POST['last_name'];
                            // $_SESSION["department"] = $_POST['department'];
                            // $_SESSION["type_"] = "EMP"; -->
                        <!-- <div class="col-lg-4 btnNameP" style=" margin-top:30px ;display: flex ">
                            <div c
                                style="font-family : Prompt ; width:80px;height:35px ;background-color: #fff ;display:flex;justify-content:center;align-items:center;border-radius:50px;color:#000 ;border: solid;border-width: 1px;border-color: #999">
                                แก้ไข
                            </div>
                        </div> -->
                    </div>
                    <div class="row feature_inner"
                        style="width:100% ; display: flex;flex-direction: row ; margin-top:0px">
                        <!-- <div class="col-lg-4"
                            style=" margin-top:30px ;display: flex ;flex-direction: row ; align-items: center">
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                                ตำแหน่ง</p>
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                            </p>
                        </div> -->
                        <div class="col-lg-4"
                            style=" margin-top:30px ;display: flex ;flex-direction: row ; align-items: center">
                            <p class="main_position" style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                            ตำแหน่ง {{$employee->position}}</p>
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                        ...
                        <div class="col-lg-4"
                            style=" margin-top:30px ;display: flex ;flex-direction: row ; align-items: center">
                            <p class="main_birth" style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                                วันเกิด {{$employee->company}}</p>
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                            </p>
                        </div>
                        <div class="col-lg-4"
                            style=" margin-top:30px ;display: flex ;flex-direction: row ; align-items: center">
                            <p class="main_start" style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                                วันที่เริ่มเข้างาน {{$employee->start_work}}</p>
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row feature_inner"
                        ...
                        <div class="col-lg-4"
                            style=" margin-top:30px ;display: flex ;flex-direction: row ; align-items: center">
                            <p class="main_depart" style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
                            แผนก  {{$employee->department}}</p>
                            <p style="font-family : Prompt ; margin-bottom:0px ;font-size: 22px ;color:#000">
       ...
       <label >วิชาที่ต้องเรียน</label>
        <div style="overflow-x:auto;">
            <table>
              ...
              @foreach ($vichar as $item)
              <tr>
              <td>{{$item['code_']}}</td>
                <td>{{$item['name_vichar']}}</td>
                <td>{{$item['paped']}}</td>
                <td>
                    <a href=" {{url('learningCorse/'.$item['id'])}}"  class="btn btn-warning" >เข้าเรียน</a>   </td>

                 <td>
                 <a data-id="{{$item['id']}}" href="javascript:void(0)"  class="btn btn-info show_score_test" >ดูคะแนน</a>   </td>
                </td>
              </tr>
              @endforeach
          ...
          <div id="score_test" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">ผลคะแนนวิชา  <span  id="name_vichar"></span></h4>
                </div>
    ...
    <script src="{{asset('js/get_score_test.js')}}"></script>
